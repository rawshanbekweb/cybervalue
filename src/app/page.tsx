        ...
        <div>
          ...
          {activity.length ? (
            ...
            <div className="activity-empty">
              ...
              <div>
                <span className="eyebrow">A record, not a highlight reel</span>
                <h3>Progress leaves a trail.</h3>
                <p>
                  New projects, findings, and writeups will appear here as they
                  are published.
                </p>
      ...
      <section className="connect-strip">
        ...
        <div className="social-links">
          {socials.length ? (
            ...
            <ArrowLink href="/about#connect">Connect with CyberValue</ArrowLink>
          )}
        </div>
      </section>
    </div>
